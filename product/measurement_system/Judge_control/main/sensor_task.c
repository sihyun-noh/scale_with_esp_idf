...
#include "atlas_ec_params.h"
     ...
     (CONFIG_DATALOGGER_RS_ECTH) || (CONFIG_MS_RS485_MODBUS))
...
mb_characteristic_info_t mb_characteristic[4] = { 0 };
#endif
...
float* read_weight(void) {
  ...
  int data_len = 0;
  uint8_t value[30] = { 0 };
  static char s_weight[10] = { 0 };
  static float f_weight = 0.0;
  uint32_t u_weight = 0;
  uint32_t u_weight_sp_1 = 0;
  uint32_t u_weight_sp_2 = 0;
  uint32_t u_weight_relay_mode = 0;
