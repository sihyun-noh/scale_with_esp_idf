...
lv_obj_t *ui_Scree2ExampleLaBel2;
...
lv_obj_set_style_text_font(ui_Screen1ZoneNum1, &ui_font_Display24, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_font(ui_Screen1ZoneNum2, &ui_font_Display24, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_font(ui_Screen1ZoneNum3, &ui_font_Display24, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_font(ui_Screen1ZoneNum4, &ui_font_Display24, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_font(ui_Screen1ZoneNum5, &ui_font_Display24, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_text_font(ui_Screen1ZoneNum6, &ui_font_Display24, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_border_color(ui_Screen1OperationListLabel14, lv_color_hex(0x000000), LV_PART_MAIN | LV_STATE_DEFAULT );
...
lv_obj_set_x( ui_Screen2MainPanel, -1 );
lv_obj_set_y( ui_Screen2MainPanel, 0 );
...
lv_obj_set_x( ui_Screen2SaveButton, 147 );
lv_obj_set_y( ui_Screen2SaveButton, -90 );
...
lv_label_set_text(ui_Screen2SaveButtonLabel,"seve");
...
ui_Scree2ExampleLaBel2 = lv_label_create(ui_Screen2);
lv_obj_set_width( ui_Scree2ExampleLaBel2, LV_SIZE_CONTENT);  /// 1
lv_obj_set_height( ui_Scree2ExampleLaBel2, LV_SIZE_CONTENT);   /// 1
lv_obj_set_x( ui_Scree2ExampleLaBel2, -110 );
lv_obj_set_y( ui_Scree2ExampleLaBel2, -53 );
lv_obj_set_align( ui_Scree2ExampleLaBel2, LV_ALIGN_CENTER );
lv_label_set_text(ui_Scree2ExampleLaBel2,"e.g. 200/3,5,6/10:00");
