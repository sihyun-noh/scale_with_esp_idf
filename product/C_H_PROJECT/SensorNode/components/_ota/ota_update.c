...
#if CONFIG_OTA_FIRMWARE_UPGRADE_BIND_IF_ETH
static const char *bind_interface_name = OTA_NETIF_DESC_ETH;
#elif CONFIG_OTA_FIRMWARE_UPGRADE_BIND_IF_STA
static const char *bind_interface_name = OTA_NETIF_DESC_STA;
#endif
#endif

static const char *TAG = "ota_firmware_update";
