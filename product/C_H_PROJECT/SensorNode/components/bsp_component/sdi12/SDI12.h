...
typedef enum { ESP_INPUT = 0, ESP_OUTPUT, ESP_INPUT_PULLUP, ESP_INPUT_PULLDOWN } esp_gpio_mode_t;
...
class SDI12 {
  ...
  void handleInterrupt_idf();
  static void IRAM_ATTR isr_wrapper(void* arg);  // ISR 포인터 등록용
