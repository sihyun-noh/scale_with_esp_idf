...
/* Value topic name for actuator */
#define ACTUATOR_SWITCH_PUB_SUB_TOPIC "value/%s/switch"
#define ACTUATOR_MOTOR_PUB_SUB_TOPIC "value/%s/motor"
...
#define REQRES_V_SWITCH "switch"
#define REQRES_V_MOTOR "motor"
